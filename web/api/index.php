...
switch ($_GET['page']) {
	...
	case 'redeem':
		...
		$out = curl('http://api.steampowered.com/IPlayerService/GetOwnedGames/v0001/?key=2735B39974DC55E910C10CF0EE37CBBB&steamid='.$user['steamid'].'&format=json');
		...
		try
		{
			...
			if (!$openid->mode) {
				...
				if ($openid->validate()) {
					...
					$url = "http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=2735B39974DC55E910C10CF0EE37CBBB&steamids=$matches[1]";
	...
	case 'get_bank_safe':
		...
		$g = curl('https://www.google.com/recaptcha/api/siteverify?secret=6LfQVwsUAAAAAAOk5XBRzEXwWflMv3ecSYvtkPHN&response='.$_GET['g-recaptcha-response']);
